...
/**
 * Tests the PLS1 algorithm.
 *
 * @author FracPete (fracpete at waikato dot ac dot nz)
 */
public class PLS1Test
  extends AbstractPLSTest<PLS1> {
   ...
   */
  @Override
  protected PLS1[] getRegressionSetups() {
    PLS1[]	result;
  ...
  public static Test suite() {
    return new TestSuite(PLS1Test.class);
  }
