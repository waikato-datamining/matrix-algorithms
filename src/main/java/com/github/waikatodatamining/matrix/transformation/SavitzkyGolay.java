 ...
 */
public class SavitzkyGolay extends AbstractTransformation {
  ...
  protected Matrix doInverseTransform(Matrix data) {
    throw new UnsupportedOperationException("Cannot perform the inverse of the Savitzky-Golay transform");
  }
