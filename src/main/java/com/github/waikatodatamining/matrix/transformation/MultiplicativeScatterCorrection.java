 ...
 */
public class MultiplicativeScatterCorrection extends AbstractTransformation {

  protected AbstractTransformation m_PreFilter;

  protected AbstractMultiplicativeScatterCorrection m_Correction = new RangeBased();

  protected Matrix m_Average;

  public void setPreFilter(AbstractTransformation value) {
    m_PreFilter = value;
  }
  ...
  protected Matrix doInverseTransform(Matrix data) {
    throw new UnsupportedOperationException("Cannot perform the inverse transform of Multiplicative " +
                                            "Scatter Correction");
  }
